...
%\input{content.tex}  % totale 

\input{chapter/summary.tex}
\input{chapter/Introduction.tex}
%\input{chapter/Related_Papers.tex}
\input{chapter/Datasets.tex}
\input{chapter/How_to_reach_goal.tex}
\input{chapter/Effective_problems.tex}
\input{chapter/Current_Paper_Innovation.tex}
\input{chapter/Background_Knowledge.tex}
\input{chapter/Methodology.tex}
\input{chapter/Architectures.tex}
\input{chapter/Style_Transfer.tex}
\input{chapter/Paper_Experiments.tex}
\input{chapter/Qualitative_result.tex}
\input{chapter/Disentangling_Style_and_Content.tex}
\input{chapter/Pose_and_background_transfer_style.tex}
\input{chapter/Sentence_Interpolation.tex}
\input{chapter/Training_on_other_datasets_MOCO.tex}
