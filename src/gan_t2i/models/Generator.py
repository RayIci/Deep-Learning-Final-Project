...
class Generator(nn.Module):
    ...
    def __init__(self, embedding_dim , p_emb_dim):
        ...
        self.emb_dim = embedding_dim                         # dimension of the embedding coming from CLIP - 512
        ...
        self.Generator_net_224 = nn.Sequential(
            ...
            nn.ConvTranspose2d(self.ngf//4, self.num_channels , kernel_size=6, stride=2, padding=18, bias=False),         # H_out  = (128-1) x 2 - 2 x 1 + 4  = 8              
            nn.Tanh()
